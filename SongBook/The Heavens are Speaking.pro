...
{subtitle:Psalm 19}
{subtitle:}
{comment:V1 C1 V2 C1 C2 V3 C1}
{comment:}
{comment:print="false">}
 [A]The Heavens [Asus]are s[A]peakin’Asus
...
{soc}
 ...
 [D]We can esc[E]ape from your[A] love 
 There is [D]nowhere on[E] Earth
 [D]We can esc[E]ape from your[A] love 
{eoc}
{comment:v2}
 The Spirit is Speakin’
